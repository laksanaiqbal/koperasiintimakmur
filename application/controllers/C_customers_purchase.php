...
class C_customers_purchase extends CI_Controller
{
	...
	public function __construct()
	{
        ...
        $this->load->model('M_customers_purchase');
	}

	public function index()
	{
		$data = array(
			'title_form' => 'Report || Sales By Customer',
			'url_back'   => site_url('C_customers_purchase')
		);
		$this->load->view('template/header');
		$this->load->view('customers_purchase/index', $data);		
	...
	public function ajax_list()
    {
            ...
            $list = $this->M_customers_purchase->get_datatables($params);
            ...
            $output = array(
                "draw" => $_POST['draw'],
                "recordsTotal" => $this->M_customers_purchase->count_all($params),
                "recordsFiltered" => $this->M_customers_purchase->count_filtered($params),
                "data" => $data,
            );
        // die(var_dump($output));
