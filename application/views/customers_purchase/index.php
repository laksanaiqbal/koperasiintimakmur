            ...
            <div class="card-body">
                <form class="theme-form">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <?php
                            $this->db->order_by('a.kodecus', 'ASC');
                            $this->db->select('a.kodecus,a.namacus as NamaCust');
                            $this->db->from('customer a');
                            // $this->db->select('a.kodecus,case when a.namakirim='' then b.namacus when a.namakirim<>'' then a.namakirim END AS NamaCust');
                            ...
                            <select id="txt_nmkary" name="txt_nmkary"
                                ...
                                foreach ($customers->result() as $rows) {
                                    echo "<option value='$rows->kodecus'>$rows->NamaCust</option>";
                                }
                                ?>
                            </select>
                            <!-- <input class="form-control" id="txt_nmkary" name="txt_nmkary" type="text"
...
$(document).ready(function(e) {
    table = $('#datatable_list').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('C_customers_purchase/ajax_list') ?>",
            "type": "POST",
            "data": function(data) {
                $('#loader').hide();
