                 ...
                 <div class="col-sm-12">
                     ...
                     <div class="card-body">
                         <form method="POST" id="frm_Edit" class="theme-form">
                             <div class="mb-3 row">
                                 <label class="col-sm-3 col-form-label" for="kodesat">Kode Satuan</label>
                                 <div class="col-sm-3">
                                     <input class="form-control" id="kodesat" name="kodesat" type="text" placeholder="Type Code Here">
                                 </div>
                             </div>
                             <div class="mb-3 row">
                                 <label class="col-sm-3 col-form-label" for="namasat">Nama Kelompok</label>
                                 <div class="col-sm-3">
                                     <input class="form-control" id="namasat" name="namasat" type="text" placeholder="Type Name Here">
                                 </div>
                             </div>
 ...
 <script type="text/javascript">
     ...
     $('#frm_Edit').submit(function(e) {
         urls = "<?php echo site_url('C_satuan/update_proses') ?>";
