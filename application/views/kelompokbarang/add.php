                 ...
                 <div class="col-sm-12">
                     ...
                     <div class="card-body">
                         <form method="POST" id="inputFrm" class="theme-form" enctype="multipart/form-data">
                             <div class="mb-3 row">
                                 <label class="col-sm-3 col-form-label" for="txt_input_kodeklmpk">Kode Kelompok</label>
                                 <div class="col-sm-3">
                                     <input class="form-control" id="txt_input_kodeklmpk" name="txt_input_kodeklmpk" type="number" placeholder="Type Code Here">
                                 </div>
                             </div>
                             <div class="mb-3 row">
                                 <label class="col-sm-3 col-form-label" for="txt_input_namaklmpk">Nama Kelompok</label>
                                 <div class="col-sm-3">
                                     <input class="form-control" id="txt_input_namaklmpk" name="txt_input_namaklmpk" type="text" placeholder="Type Name Here">
                                 </div>
                             </div>
 ...
 <script type="text/javascript">
     ...
     $('#inputFrm').submit(function(e) {
         urls = "<?php echo site_url('C_kelompokbarang/input_proses') ?>";
