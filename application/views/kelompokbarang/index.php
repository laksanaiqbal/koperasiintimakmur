            ...
            <div class="card-body">
                <form class="theme-form">
                    ...
                    <!-- <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <?php
                            $this->db->select("kodeklmpk,namaklmpk");
                            $this->db->from('kelompok a');
                            $this->db->order_by('kodeklmpk', 'ASC');
                            $kelompoks = $this->db->get(); ?>
                            <select id="txt_nmkary" name="txt_nmkary">
                                <option value="">Silahkan Pilih</option>
                                <?php
                                foreach ($kelompoks->result() as $rowkelompoks) {
                                    echo "<option value='$rowkelompoks->kodeklmpk'>$rowkelompoks->namaklmpk</option>";
                                }
                                ?>
                            </select>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        table = $('#datatable_list').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('C_kelompokbarang/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
                    $('#loader').hide();
