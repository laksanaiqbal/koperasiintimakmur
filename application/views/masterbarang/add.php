                 ...
                 <div class="col-sm-12">
                     ...
                     <div class="card-body">
                         <form method="POST" id="inputFrm" class="theme-form" enctype="multipart/form-data">
                             ...
                             <div class="mb-2 row">
                                 <label class="col-sm-3 col-form-label" for="txt_input_kodekategori">Kategori</label>
                                 <div class="col-sm-9">
                                     <div class="checkbox">
