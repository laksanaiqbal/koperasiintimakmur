                    ...
                    <div class="card-body">
                        <form method="POST" id="inputFrm" class="theme-form" enctype="multipart/form-data">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="txt_input_kodebrg" name="txt_input_kodebrg" type="number" readonly placeholder="Type Code Here">
                                </div>
...
<script type="text/javascript">
    $('#btn_input').click(function() { //button filter event click
        ...
        document.getElementById("txt_input_kodebrg").value = x;
