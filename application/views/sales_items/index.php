        ...
        <div class="card">
            <div class="card-body">
                <form class="theme-form">
                    <!-- <div class="mb-3 row">
                        <div class="col-sm-5">
                            <button id="btn_input" class="btn btn-pill btn-outline-info btn-air-info" type="button"
                                title="btn btn-pill btn-outline-info btn-air-info"><i class="fa fa-plus-square">
                                    New Input </i></button>
                        </div>
                    </div> -->
                    <div class="mb-3 row">
...
$(document).ready(function(e) {
    table = $('#datatable_list').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('C_sales_items/ajax_list') ?>",
            "type": "POST",
            "data": function(data) {
                $('#loader').hide();
