...
<?php $this->load->view('PO/add') ?>
<?php $this->load->view('GoodReceipt/open_image') ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        table = $('#datatable_list').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('C_GoodReceipt/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
                    $('#loader').hide();
    ...
    //     $.ajax({
    //         url: "<?php echo site_url('C_GoodReceipt/ajax_logger_edit') ?>/" + kodebrg,
    //         type: "GET",
    //         dataType: "JSON",
    ...
    $('#btn_input').click(function() { //button filter event click
        ...
        $('.modal-title').text('  Tambah GoodReceipt'); // Set Title to Bootstrap modal title
    ...
    //     //Ajax Load data from ajax
    //     $.ajax({
    //         url: "<?php echo site_url('C_GoodReceipt/ajax_edit') ?>/" + kodebrg,
    //         type: "GET",
    //         dataType: "JSON",
    //         success: function(data) {
    ...
    //     var data_id = id;
    //     var urls = '<?= site_url("C_GoodReceipt/delete_permanen/"); ?>';
    //     swal({
    //             title: "Are you sure?",
    ...
    function openimage(noorder) {
        ...
        $.ajax({
            url: "<?php echo site_url('C_GoodReceipt/ajax_openimage') ?>/" + noorder,
            type: "POST",
            data: {
                'noorder': id
            },
    ...
    //     var data_id = id;
    //     var urls = '<?= site_url("C_GoodReceipt/delete_archive/"); ?>';
    //     swal({
    //             title: "Are you sure?",
    ...
    // function recover(id) {
    //     var data_id = id;
    //     var urls = '<?= site_url("C_GoodReceipt/recovery/"); ?>';
    //     swal({
    //             title: "Are you sure?",
