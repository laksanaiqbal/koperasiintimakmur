...
<?php $this->load->view('PO/open_image') ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        table = $('#datatable_list').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('C_PO/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
                    $('#loader').hide();
    ...
    //     $.ajax({
    //         url: "<?php echo site_url('C_PO/ajax_logger_edit') ?>/" + kodebrg,
    //         type: "GET",
    //         dataType: "JSON",
    ...
    //     //Ajax Load data from ajax
    //     $.ajax({
    //         url: "<?php echo site_url('C_PO/ajax_edit') ?>/" + kodebrg,
    //         type: "GET",
    //         dataType: "JSON",
    //         success: function(data) {
    ...
    //     var data_id = id;
    //     var urls = '<?= site_url("C_PO/delete_permanen/"); ?>';
    //     swal({
    //             title: "Are you sure?",
    ...
    //     var data_id = id;
    //     var urls = '<?= site_url("C_PO/delete_archive/"); ?>';
    //     swal({
    //             title: "Are you sure?",
    ...
    function approval(id) {
        var data_id = id;
        var urls = '<?= site_url("C_PO/approval/"); ?>';
        swal({
                title: "Are you sure?",
                text: "Do you realy want to disable this data?!",
                icon: "warning",
    ...
    function Rejected(id) {
        var data_id = id;
        var urls = '<?= site_url("C_PO/Rejected/"); ?>';
        swal({
                title: "Are you sure?",
                text: "Do you realy want to disable this data?!",
                icon: "warning",
    ...
    function openimage(noorder) {
        ...
        $.ajax({
            url: "<?php echo site_url('C_PO/ajax_openimage') ?>/" + noorder,
            type: "POST",
            data: {
                'noorder': id
            },
