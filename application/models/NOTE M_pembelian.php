...
class M_pembelian extends CI_Model
{
    ...
    var $column_order = array(null, 'a.id_detail', 'a.id_pembelian', 'a.id_barang', 'a.kode_detail', 'a.harga_beli', 'a.harga_jual', 'a.qty', 'a.total', 'a.id_sup'); //set column field database for datatable orderable
    var $column_search = array('a.id_detail', 'a.id_pembelian', 'a.id_barang', 'a.kode_detail', 'a.harga_beli', 'a.harga_jual', 'a.qty', 'a.total', 'a.id_sup'); //set column field database for datatable searchable 
    ...
    private function _get_datatables_query()
    {
        $month = date('m') - 3;
        $years = date('Y');
        $this->db->select("a.id_detail,b.barcode, c.namasup, a.id_pembelian,b.namabrg,b.kodebrg, a.id_barang, a.kode_detail, a.harga_beli, a.harga_jual, a.qty,a.total, a.id_sup");
        $this->db->from('detail_pembelian a');
        $this->db->where("a.id_pembelian='0'");
    ...
    function get_datatabless($params)
    {
        ...
        //jika parameter yang di set txt_nmkary
        if (isset($params['txt_nmkary'])) {
            $this->db->where('a.id_pembelian', $params['txt_nmkary']);
        }
    ...
    {
        $this->db->select("a.id_detail, a.id_pembelian, a.id_barang, a.kode_detail, a.harga_beli, a.harga_jual, a.qty,a.total, a.id_sup");
        $this->db->from('detail_pembelian a');
